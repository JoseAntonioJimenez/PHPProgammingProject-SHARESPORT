...
?>
<h1 id="header_register">Are you not yet registered to our page? Register now!!</h1>
<form action="Register.php" method="post">
<div id="formul">
    <h2>Registration Form</h2>
    <hr>
	<p>Name: <input type="text" id="textbox" name="name" size="15" maxlength="20" value="<?php if (isset($_POST['name'])) echo $_POST['name']; ?>"></p>
	...
	<p>Email Address: <input type="email" id="textbox" name="email" size="20" maxlength="60" value="<?php if (isset($_POST['email'])) echo $_POST['email']; ?>" > </p>
	...
	<p>Prefered Sports: <input type="text" id="textbox" name="prefered" size="15" maxlength="20" value="<?php if (isset($_POST['prefered'])) echo $_POST['prefered']; ?>"></p>
	<p>Prefered Days: <input type="text" id="textbox" name="days" size="15" maxlength="20" value="<?php if (isset($_POST['days'])) echo $_POST['days']; ?>"></p>
	<p>Age: <input type="number" id="textbox" name="age" size="15" maxlength="20" value="<?php if (isset($_POST['age'])) echo $_POST['age']; ?>"></p>
